...
export function buildParseLegacySystemPrompt(): string {
	return (
		...
		`For figure blocks, set caption, diagram_type, elements object, status \"pending\"; leave svg, image_url, render_method, generation_model, error_message null; unused block fields null. ` +
